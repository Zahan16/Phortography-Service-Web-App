    ...
    <header>
        <nav class="navbar fixed-top">
            <div class="container-fluid">
                ...
                <a class="navbar-title position-absolute top-50 start-50 translate-middle" href="events_packages.php">Events Packages</a>
    ...
    <main>
        <div class="container">
            ...
            <table>
                ...
                <tr>
                    <td>Basic Event Package</td>
                    <td>
                        <ul>
                            <li>2 hours of coverage</li>
                            <li>50 edited high-resolution digital images</li>
                ...
                <tr>
                    <td>Premium Event Package</td>
                    <td>
                        <ul>
                            <li>6 hours of coverage</li>
                            <li>200 edited high-resolution digital images</li>
                            <li>Online gallery for viewing and downloading</li>
                        </ul>
                    </td>
                    <td>$1,000</td>
